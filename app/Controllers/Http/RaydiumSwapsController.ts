...
export default class RaydiumSwapsController {
    ...
    async getSwapTransaction(
        ...
        // console.log(toToken, amount, poolKeys, maxLamports, useVersionedTransaction, fixedSide)
        ...
        console.log('minAmountOut:', minAmountOut.toFixed(), '  amountIn: ', amountIn.toFixed())
    ...
    async calcAmountOut(poolKeys: LiquidityPoolKeys, rawAmountIn: number, swapInDirection: boolean) {
        ...
        const slippage = new Percent(49, 100) // 5% slippage
